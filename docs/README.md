...
Reference material for Luxe.
The [project README](../README.md) is the short version; everything below is the detail it leaves out.

| Page                                | What is in it                                                                                        |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------- |
| [Install](install.md)               | Installing the skill, the zero-setup route, sandbox fallbacks, and the two names Luxe goes by        |
| [CLI reference](cli.md)             | Every command, every flag, and the playbook IDs                                                      |
...
- [`security/mermaid-11.12-risk-acceptance.md`](security/mermaid-11.12-risk-acceptance.md) is the recorded risk acceptance for the bundled Mermaid version.
